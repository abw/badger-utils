...
test(
  'hash() array',
  t => {
    t.deepEqual(hash(cd), { c: true, d: true });
  }
);
...
test(
  ...
  t => {
    t.deepEqual(hash(ef), { e: true, f: true });
  }
);
...
test(
  ...
  t => {
    t.deepEqual(hash(gh), { g: true, h: true });
  }
);
...
test(
  ...
  t => {
    t.deepEqual(hash(ij), { i: true, j: true });
  }
);
